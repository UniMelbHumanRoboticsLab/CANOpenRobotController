...
#ifndef RobotM2P_H_INCLUDED
#define RobotM2P_H_INCLUDED
...
/**
 * \brief Implementation of the M2 robot class, representing an M2 using 2 JointM2P
 */
class RobotM2P: public Robot {
   ...
   public:
    /**
      * \brief Default <code>RobotM2P</code> constructor.
      ...
      */
    RobotM2P(std::string robot_name="", std::string yaml_config_file="");
    ~RobotM2P();
