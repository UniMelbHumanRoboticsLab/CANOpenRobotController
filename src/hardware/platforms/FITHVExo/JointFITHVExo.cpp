...
JointFITHVExo::JointFITHVExo(int jointID, double q_min, double q_max, short int sign_, double dq_min, double dq_max, double tau_min, double tau_max, CopleyDrive *drive, const std::string& name) :   Joint(jointID, q_min, q_max, drive, name),
                                                                                                                                                                sign(sign_),
...
setMovementReturnCode_t JointFITHVExo::setPosition(double qd) {
    if (calibrated) {
...
setMovementReturnCode_t JointFITHVExo::setVelocity(double dqd) {
...
setMovementReturnCode_t JointFITHVExo::setTorque(double taud) {
    //Position protection first only if calibrated
    if (calibrated) {
...
bool JointFITHVExo::initNetwork() {
    spdlog::debug("JointFITHVExo::initNetwork()");
    if (((CopleyDrive *)drive)->init()) {
        return true;
    } else {
        return false;
    }
