...
const float controlLoopPeriodInms = 5; /*!< Define the control loop period (in ms): the period of rt_control_thread loop. */
const float CANUpdateLoopPeriodInms = 50; /*!< Define the CAN PDO sync message period (and so PDO update rate). In ms. Less than 3 can lead to unstable communication  */
