...
/*0x1600*/ CO_OD_entryRecord_t OD_record1600[9] = {
    {(void *)&OD_RPDOMappingParameter[0]->numberOfMappedObjects, 0x0e, 0x1},
    {(void *)&OD_RPDOMappingParameter[0]->mappedObject1, 0x8e, 0x4},
    {(void *)&OD_RPDOMappingParameter[0]->mappedObject2, 0x8e, 0x4},
    {(void *)&OD_RPDOMappingParameter[0]->mappedObject3, 0x8e, 0x4},
    {(void *)&OD_RPDOMappingParameter[0]->mappedObject4, 0x8e, 0x4},
    {(void *)&OD_RPDOMappingParameter[0]->mappedObject5, 0x8e, 0x4},
    {(void *)&OD_RPDOMappingParameter[0]->mappedObject6, 0x8e, 0x4},
    {(void *)&OD_RPDOMappingParameter[0]->mappedObject7, 0x8e, 0x4},
    {(void *)&OD_RPDOMappingParameter[0]->mappedObject8, 0x8e, 0x4},
};
...
bool_t CO_configure(void) {
    ...
    for (i = 0; i < CO_NO_RPDO; i = i + 1) {
        CO_OD_set_entry(25 + i, 0x1400 + i, 0x02, 0x00, 0, (void *)&OD_record1400);
    }
    for (i = 0; i < CO_NO_RPDO; i = i + 1) {
        CO_OD_set_entry(25 + CO_NO_RPDO + i, 0x1600 + i, 0x08, 0x00, 0, (void *)&OD_record1600);
    }
