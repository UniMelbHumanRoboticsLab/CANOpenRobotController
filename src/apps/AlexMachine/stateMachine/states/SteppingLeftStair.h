 ...
 *
 */
#ifndef SteppingLeftStair_H_INCLUDED
#define SteppingLeftStair_H_INCLUDED
 ...
 *
 */
class SteppingLeftStair : public ExoTestState {
   public:
    void entry(void);
    void during(void);
    void exit(void);
    SteppingLeftStair(StateMachine *m, AlexRobot *exo, AlexTrajectoryGenerator *tg, const char *name = NULL) : ExoTestState(m, exo, tg, name){};
};
