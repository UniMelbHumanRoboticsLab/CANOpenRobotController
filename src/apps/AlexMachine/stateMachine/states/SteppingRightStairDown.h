 ...
 *
 */
#ifndef SteppingRightStairDown_H_INCLUDED
#define SteppingRightStairDown_H_INCLUDED
 ...
 *
 */
class SteppingRightStairDown : public ExoTestState {
   public:
    void entry(void);
    void during(void);
    void exit(void);
    SteppingRightStairDown(StateMachine *m, AlexRobot *exo, AlexTrajectoryGenerator *tg, const char *name = NULL) : ExoTestState(m, exo, tg, name){};
};
