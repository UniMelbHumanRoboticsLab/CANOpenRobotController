 ...
 *
 */
#ifndef SteppingRightStair_H_INCLUDED
#define SteppingRightStair_H_INCLUDED
 ...
 *
 */
class SteppingRightStair : public ExoTestState {
   public:
    void entry(void);
    void during(void);
    void exit(void);
    SteppingRightStair(StateMachine *m, AlexRobot *exo, AlexTrajectoryGenerator *tg, const char *name = NULL) : ExoTestState(m, exo, tg, name){};
};
