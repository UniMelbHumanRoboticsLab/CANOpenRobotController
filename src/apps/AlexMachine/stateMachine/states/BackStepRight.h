 ...
 * 
 */
#ifndef BackStepRight_H_INCLUDED
#define BackStepRight_H_INCLUDED
 ...
 * 
 */
class BackStepRight : public ExoTestState {
   public:
    void entry(void);
    void during(void);
    void exit(void);
    BackStepRight(StateMachine *m, AlexRobot *exo, AlexTrajectoryGenerator *tg, const char *name = NULL) : ExoTestState(m, exo, tg, name){};
};
